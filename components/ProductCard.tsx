  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-2xl bg-zinc-100">
        ...
        <button className="pointer-events-none absolute inset-x-3 bottom-3 flex items-center justify-center rounded-full bg-white/90 py-2 text-[10px] font-semibold uppercase tracking-[0.22em] text-zinc-900 opacity-0 shadow-sm transition-all duration-300 group-hover:pointer-events-auto group-hover:opacity-100">
          Quick add
        </button>
      </div>
